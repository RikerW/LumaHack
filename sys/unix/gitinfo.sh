#!/bin/sh
# LumaHack 3.6  gitinfo.sh	$NHDT-Date: 1524689450 2018/04/25 20:50:50 $  $NHDT-Branch: LumaHack-3.6.0 $:$NHDT-Revision: 1.2 $
...
# (for lumahack's 'v' command) with more specific information.  That is not
...
# try to run a perl script which is part of lumahack's git repository
if [ $rungit -eq 1 ]; then
  ( cd $prefix; \
