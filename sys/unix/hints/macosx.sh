#!/bin/sh
# LumaHack 3.6  macosx.sh $NHDT-Date: 1517231957 2018/01/29 13:19:17 $  $NHDT-Branch: githash $:$NHDT-Revision: 1.20 $
...
<dict>
        ...
        <string>LumaHack $SVSDOT for the MacOS X Terminal
</string>
        <key>IFPkgDescriptionTitle</key>
        <string>LumaHack</string>
...
<dict>
	...
	<string>LumaHack $SVSDOT for the MacOS X Terminal</string>
	<key>CFBundleIdentifier</key>
	<string>org.lumahack.term</string>
