/* LumaHack 3.6	mhstatus.c	$NHDT-Date: 1536411224 2018/09/08 12:53:44 $  $NHDT-Branch: LumaHack-3.6.2-beta01 $:$NHDT-Revision: 1.29 $ */
...
typedef struct mswin_lumahack_status_window {
    int index;
