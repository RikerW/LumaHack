/* LumaHack 3.6	mhmsgwnd.c	$NHDT-Date: 1432512812 2015/05/25 00:13:32 $  $NHDT-Branch: master $:$NHDT-Revision: 1.32 $ */
...
typedef struct mswin_lumahack_message_window {
    size_t max_text;
...
NHMessageWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE: {
        ...
        /* update LumaHack internal window position */
