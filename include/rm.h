/* LumaHack 3.6	rm.h	$NHDT-Date: 1573943499 2019/11/16 22:31:39 $  $NHDT-Branch: LumaHack-3.6 $:$NHDT-Revision: 1.66 $ */
 ...
 * and generalized for LumaHack's release 2 by Eric S. Raymond (eric@snark)
