/* LumaHack 3.6	tradstdc.h	$NHDT-Date: 1555361295 2019/04/15 20:48:15 $  $NHDT-Branch: LumaHack-3.6.2-beta01 $:$NHDT-Revision: 1.36 $ */
 ...
 * potentially trickier, but lumahack uses it in a straightforward manner.
 */
 ...
 * sizeof (char *).
 * LumaHack avoids floating point, and any configuration able to use
...
/* This is inherently risky, and should only be attempted as a
   ...
   [lumahack's core doesn't use VA_NEXT() so doesn't use VA_SHIFT()
 ...
 * unwidened argument types.  Thus, we have to turn off all LumaHack
...
#ifdef __clang__
/* clang's gcc emulation is sufficient for lumahack's usage */
#ifndef __GNUC__
#define __GNUC__ 4
#endif
#endif
