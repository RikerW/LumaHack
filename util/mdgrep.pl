#!perl
# LumaHack 3.6  mdgrep.pl  $NHDT-Date: 1524684408 2018/04/25 19:26:48 $  $NHDT-Branch: LumaHack-3.6.0 $:$NHDT-Revision: 1.16 $
...
sub start_file {
	...
	my $branch = '$NHDT-Branch: LumaHack-3.6.0 $';
...
# before generating mdgrep.h and committing that file).
	print OUT <<E_O_M;
/*
 * LumaHack 3.6  $outfile  $date $branch:$revision
