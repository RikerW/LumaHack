/* LumaHack 3.6	hacklib.c	$NHDT-Date: 1552639487 2019/03/15 08:44:47 $  $NHDT-Branch: LumaHack-3.6.2-beta01 $:$NHDT-Revision: 1.67 $ */
...
/*=
    ...
    LumaHack, except that rounddiv may call panic().  setrandom calls one
